...
print(style.bright_black("Light black color"))
print(style.grey("Grey color"))
...
print(style.on.bright_black("On light black color"))
print(style.on.grey("On grey color"))
