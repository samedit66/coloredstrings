...
class StyleBuilder:
    ...
    def black(self) -> StyleBuilder:
        return self._with_color(Color.BLACK)

    @property
    def red(self) -> StyleBuilder:
        return self._with_color(Color.RED)

    @property
    def green(self) -> StyleBuilder:
        return self._with_color(Color.GREEN)

    @property
    def yellow(self) -> StyleBuilder:
        return self._with_color(Color.YELLOW)

    @property
    def blue(self) -> StyleBuilder:
        return self._with_color(Color.BLUE)

    @property
    def magenta(self) -> StyleBuilder:
        return self._with_color(Color.MAGENTA)

    @property
    def cyan(self) -> StyleBuilder:
        return self._with_color(Color.CYAN)

    @property
    def white(self) -> StyleBuilder:
        return self._with_color(Color.WHITE)

    @property
    def bright_black(self) -> StyleBuilder:
        return self._with_color(Color.BRIGHT_BLACK)
    ...
    def bright_red(self) -> StyleBuilder:
        return self._with_color(Color.BRIGHT_RED)

    @property
    def bright_green(self) -> StyleBuilder:
        return self._with_color(Color.BRIGHT_GREEN)

    @property
    def bright_yellow(self) -> StyleBuilder:
        return self._with_color(Color.BRIGHT_YELLOW)

    @property
    def bright_blue(self) -> StyleBuilder:
        return self._with_color(Color.BRIGHT_BLUE)

    @property
    def bright_magenta(self) -> StyleBuilder:
        return self._with_color(Color.BRIGHT_MAGENTA)

    @property
    def bright_cyan(self) -> StyleBuilder:
        return self._with_color(Color.BRIGHT_CYAN)

    @property
    def bright_white(self) -> StyleBuilder:
        return self._with_color(Color.BRIGHT_WHITE)

    def color256(self, index: int) -> StyleBuilder:
        return self._with_color(Extended256(index=index))

    def rgb(self, r: int, g: int, b: int) -> StyleBuilder:
        return self._with_color(Rgb(r=r, g=g, b=b))
    ...
    def bold(self) -> StyleBuilder:
        return self._with_attrs(Attribute.BOLD)
    ...
    def underline(self) -> StyleBuilder:
        return self._with_attrs(Attribute.UNDERLINE)
    ...
    def hidden(self) -> StyleBuilder:
        return self._with_attrs(Attribute.HIDDEN)
    ...
    def _with_attrs(self, *attrs: Attribute) -> StyleBuilder:
    ...
    def _with_color(self, color: typing.Union[Color, Extended256, Rgb]) -> StyleBuilder:
        """
